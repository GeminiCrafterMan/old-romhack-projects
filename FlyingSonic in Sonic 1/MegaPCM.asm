...
; ---------------------------------------------------------------
	...
	DAC_Entry	$09, DSALTDI7, pcm+pri		; $84	- AAAAAAAAAAAAA
	DAC_Entry	$09, DSALTOW7, pcm+pri		; $85	- UH UH UH UH
	DAC_Entry	$09, O_CHRSEL, pcm+pri+loop		; $86	- O_CHRSEL from 2.0
	dc.l	0,0					; $87	- <Free>
...
; ---------------------------------------------------------------
	...
	IncludeDAC	DSALTDI7, wav
	IncludeDAC	DSALTOW7, wav
	IncludeDAC	O_CHRSEL, wav
	even
