...
SonAni_Falling:	dc.b 3, $6D, $6E, $6F, -2, 2, $FE
		even
; ---------------------------------------------------------------------------
...
SuperSonicAniData:
		...
		dc.w SonAni_Falling-SuperSonicAniData	;26
		dc.w SupSonAni_4thRun-SuperSonicAniData		;27
SupSonAni_Walk:	dc.b  $FF,   $A4,	  $A5,   $9E,   $9F,	 $A0,   $A1,   $A2,	$A3, $FF
SupSonAni_Run:	dc.b $FF, $BE, $BF, $C0, $C1, $C0,$BF,$FF,$FF,$FF
SupSonAni_Push:	dc.b  $FD, $51,	$52, $53, $54, $FF, $FF, $FF	; placeholder
SupSonAni_Wait:	dc.b    7,$97,$98,$99,$98,$FF
SupSonAni_Balance:	dc.b	5, $45, $46, $47, $FF	; also placeholder
SupSonAni_LookUp:	dc.b	5, $9C,	$9D, $FE,   1	; omg
SupSonAni_Duck:	dc.b	5, $9A,	$9B, $FE,   1	; woah
SupSonAni_Stop:	dc.b 7,	$E1, $70, $FF	; was a bitch to put in
SupSonAni_Float1:	dc.b 7,	$5C, $6B, $FF	; never
SupSonAni_Float2:	dc.b 7,	$5C, $5D, $5E, $5F, $61, $62, $63, $FF, 0	; NEVERRR
SupSonAni_LZHang:	dc.b 4,	$E2, $E3, $FF	; Reused SonAni_4thRun sprites.
...
SupSonAni_SpinDash:	dc.b 0, $31, $32, $31, $33, $31, $34, $31, $35, $31, $36, $FF
SupSonAni_3rdRun:	dc.b  $FF, $CF, $D0, $FF, $FF, $FF, $FF, $FF, $FF, $FF
SupSonAni_DashCharge:	dc.b	1, $D7,	$D8, $FF
SupSonAni_Blank2:	dc.b 3,	$41, $FF
SupSonAni_DiagKick:	dc.b $20, $44, $FF, 0
SupSonAni_SuperTrans:	dc.b 1,$84,$85,$86,$87,$88,$89,$8A,$8B,$8C,$8D,$8E,$8F,$90, $91, $92, $93, $94, $95, $96, $93, $94, $95, $96, $93, $94, $95, $96, $FD,  0
SupSonAni_4thRun:	dc.b  $FF, $D9, $DA, $FF, $FF, $FF,$FF,$FF,$FF,$FF
		even
